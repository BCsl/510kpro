...
public class WaitForMsgState extends PlayerState {
    ...
    public void handle(String msg) {
        ...
        if (CommonMsgDecoder.checkMessage(msg,
            ...
            mPlayerContext.playCardsEndAction(CommonMsgDecoder.getCards(msg),
            ...
            mPlayerContext
                    .roundEndAction(CommonMsgDecoder.getPlayerScores(msg));
